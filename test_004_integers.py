...
#################################################################
# NOTE that if the user enters a STRING value, the int function above returns error!
#################################################################
...
while (user_age <= 0):
    ...
    user_age = int(input(prompt_age_msg))
#END of the while loop, for the USER-AGE intialization

#################################################################
#Print out a statement using the user_age variable
#################################################################
print()
print("yourage is", user_age, "years old")